    ...
    if($_FILES['uploadfile']['name']){
        ...
        if(end($filename) == 'csv'){
            ...
            while($data = fgetcsv($handle)){
                ...
                $query = "INSERT INTO `gptc_mech` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','MECH','$batch')";
                $result = mysqli_query($con,$query);
                $sql = "INSERT INTO `mechdue` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','MECH','$batch')";
            ...
            ?>
                <META HTTP-EQUIV="refresh" content="0;url = http://localhost/phpfiles/project/try/hod-mech/hod.php">
