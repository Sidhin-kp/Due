    ...
    if($_FILES['uploadfile']['name']){
        ...
        if(end($filename) == 'csv'){
            ...
            while($data = fgetcsv($handle)){
                ...
                $query = "INSERT INTO `gptc_ct` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','CT','$batch')";
                $result = mysqli_query($con,$query);
                $sql = "INSERT INTO `ctdue` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','CT','$batch')";
            ...
            ?>
                <META HTTP-EQUIV="refresh" content="0;url = http://localhost/phpfiles/project/try/hod-ct/hod.php">
