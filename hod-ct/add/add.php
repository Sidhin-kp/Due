    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $sql = "SELECT * FROM `gptc_ct` WHERE regno = '$r'";
                    ...
                    if($count == 1) {
                        ...
                        $b=$_POST['btch'];
                        $sql="insert into `gptc_ct`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','CT','$b')";
                        $query=mysqli_query($con,$sql);
                        $sqli="insert into `ctdue`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','CT','$b')";
