    ...
    <body>
        ...
        <select name="batch_box">
            ...
            <select name="depart">
                ...
                <option class="lt" value="elcircuitlab">Circuit Lab</option>
                <option class="lt" value="eldigitallab">Digital Lab</option>
                <option class="lt" value="elswlab">Software Lab</option>
            </select><br><br>
