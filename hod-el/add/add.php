    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $sql = "SELECT * FROM `gptc_el` WHERE regno = '$r'";
                    ...
                    if($count == 1) {
                        ...
                        $b=$_POST['btch'];
                        $sql="insert into `gptc_el`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','EL','$b')";
                        $query=mysqli_query($con,$sql);
                        $sqli="insert into `eldue`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','EL','$b')";
