    ...
    if($_FILES['uploadfile']['name']){
        ...
        if(end($filename) == 'csv'){
            ...
            while($data = fgetcsv($handle)){
                ...
                $query = "INSERT INTO `gptc_cel` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','EL','$batch')";
                $result = mysqli_query($con,$query);
                $sql = "INSERT INTO `eldue` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','EL','$batch')";
            ...
            ?>
                <META HTTP-EQUIV="refresh" content="0;url = http://localhost/phpfiles/project/try/hod-el/hod.php">
