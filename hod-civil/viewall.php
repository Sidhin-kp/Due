<?php
    ...
    $bt=$_GET['data'];
            ...
            $sql="select * from `gptc_civil` where batch='$bt'";
...
<link rel="stylesheet" href="../resource/style1.css">
    ...
    <body>
        ...
        <?php 
            $qry="SELECT SUM(collection) as total FROM civildue where batch='$bt'";
