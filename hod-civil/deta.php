    ...
    <body>
        ...
        <select name="batch_box">
            ...
            <select name="depart">
                ...
                <option class="lt" value="civilconstructionlab">Construction Lab</option>
                <option class="lt" value="civilconeretelab">Conerete Lab</option>
                <option class="lt" value="civilgeotechlab">Geotech Lab</option>
                <option class="lt" value="civilenvlab">ENV Lab</option>
                <option class="lt" value="civilsurveylab">Survey Lab</option>
                <option class="lt" value="civilmtlab">MT Lab</option>
            </select><br><br>
