    ...
    if($_FILES['uploadfile']['name']){
        ...
        if(end($filename) == 'csv'){
            ...
            while($data = fgetcsv($handle)){
                ...
                $query = "INSERT INTO `gptc_civil` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','CIVIL','$batch')";
                $result = mysqli_query($con,$query);
                $sql = "INSERT INTO `civildue` (`name`,`regno`,`admno`,`department`,`batch`) VALUES ('$name','$regno','$admno','CIVIL','$batch')";
            ...
            ?>
                <META HTTP-EQUIV="refresh" content="0;url = http://localhost/phpfiles/project/try/hod-civil/hod.php">
