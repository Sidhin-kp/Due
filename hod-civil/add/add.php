    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $sql = "SELECT * FROM `gptc_civil` WHERE regno = '$r'";
                    ...
                    if($count == 1) {
                        ...
                        $b=$_POST['btch'];
                        $sql="insert into `gptc_civil`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','CIVIL','$b')";
                        $query=mysqli_query($con,$sql);
                        $sqli="insert into `civildue`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','CIVIL','$b')";
