    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                {
                    $sql = "SELECT * FROM `gptc_che` WHERE regno = '$r'";
                    ...
                    if($count == 1) {
                        ...
                        $b=$_POST['btch'];
                        $sql="insert into `gptc_che`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','CHE','$b')";
                        $query=mysqli_query($con,$sql);
                        $sqli="insert into `chedue`(`name`,`regno`,`admno`,`department`,`batch`)values('$n','$r','$a','CHE','$b')";
